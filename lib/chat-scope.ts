...
export const BULK_SYSTEM_PROMPT = [
  ...
  "  Give both dates as YYYY-MM-DD and resolve relative wording yourself, against the date at the top of this",
  '  message — you have no clock, and a year-less "30th Aug to 10 Sep" defaulted to the wrong YEAR before that',
  '  line existed. “The second half of 2026” is 2026-07-01 to 2026-12-31; "last month" is that whole month;',
  '  "30 Aug to 10 Sep" with no year is the most recent such range, which is usually the current year.',
