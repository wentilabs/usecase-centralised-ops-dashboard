...
export const ailyticsOnboarding: OnboardDefinition = {
    ...
    fields: [
      ...
      {
        column: "yesterday_summary_enabled",
        label: "Yesterday 24h summary enabled",
        kind: "toggle",
        required: false,
        notNull: true,
        fallback: "false",
        help: "Enables the hourly previous-day findings summary. This is separate from the existing daily status summary.",
      },
      {
        column: "yesterday_summary_hour",
        ...
        fallback: "8",
        range: { min: 0, max: 23 },
        help: "Project-local hour (0-23) at which the hourly route sends the previous day's counts.",
      },
      {
        column: "yesterday_summary_group_ids",
        label: "Yesterday summary WhatsApp groups",
        kind: "groups",
        required: false,
        notNull: true,
        help: "Dedicated Safety Inspection Summary group IDs, comma-separated. These do not reuse the general WhatsApp groups.",
      },
      {
        column: "lambda_url",
